...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Post Staff Baru</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-items mx-1"><a href="index.php">Home</a></li>
                <li class="breadcrumb-items mx-1"><a href="staff.php">/ Staff </a></li>
                <li class="breadcrumb-items active">/ Post Staff</li>
            </ol>

            <form action="" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah Staff</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-10">
                                <div class="mb-3 row">
                                    <label for="nama" class="col-sm-2 col-form-label">Nama Staf/Guru</label>
                                    <label for="nama" class="col-sm-1 col-form-label">:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="nama" id="nama" placeholder="Nama Staff/guru" class="form-control border-0 border-bottom ps-2" required>
                                    </div>
                                </div>
            ...
            if (isset($_POST['simpan'])) {
                ...
                if (!in_array($formatfile, $allowedtype)) {
                    ...
                    if (move_uploaded_file($tmpname, "../uploads/staff/" . $rename)) {
                        ...
                        $simpan = mysqli_query($koneksi, "INSERT INTO staff (nama, deskripsi, foto) 
